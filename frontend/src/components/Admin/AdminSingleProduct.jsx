        ...
        toast(
          {
            ...
            description: `${formRef.current.title} has not edited.`,
            status: 'success',
            duration: 3000,
            isClosable: true,
          });
    ...
    return (
      <>
        ...
        <FormControl mt={'2'}>
          ...
          <Input id="description"  name='title' onChange={formChangeHandler} fontSize={'small'} size={'sm'} />
        </FormControl>
          <FormControl>
            <FormLabel htmlFor="brand" fontWeight={'normal'}>Rating</FormLabel>
            <Input id="brand" type="number" name='rating' onChange={formChangeHandler} size={'sm'} fontSize={'small'} />
          </FormControl>       
      </>
    );
  };
    ...
    <Center bg='white' mt='2'>
      <Box role={'group'} p={6} maxW={'200px'} w={'full'} boxShadow={'2xl'} rounded={'lg'} pos={'relative'} zIndex={1}>
        <Box
          ...
          <Image rounded={'lg'} boxSize={150} objectFit={'cover'} src={product.imglink} />
        </Box>
        <Stack align={'center'}>
